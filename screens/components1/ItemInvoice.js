...
class ItemInvoice extends Component {
  ...
  for(var t=0;t<result.entry_list.length;t++){
    that.state.subtotal=(Number(result.entry_list[t].name_value_list.quantity.value)*Number(result.entry_list[t].name_value_list.price.value))+Number(that.state.subtotal);
...
{/* <Text style={{ marginHorizontal: 30 ,marginTop:20,fontFamily:"Lato-Regular",fontSize:10}}>SIGN BELOW</Text>
  ...
  textShadowRadius: 10
                   ...
                   <Text style={{width:width-40,alignself:'center', marginHorizontal: 30,marginTop:40}}>I hereby agree that the orders mentioned above have been recieved.</Text>
