   ...
   SignItemsView = ({ item, index }) => (
    ...
    <View style={styles.flatliststyle1}>  
      ...
      <View style={{ flexDirection: "row",justifyContent:'space-evenly',alignItems:'center', backgroundColor:'#ffffff',width:width-10,alignSelf:'center' ,height:40}} >
         ...
         <Text style  ={{fontFamily:"Lato-Regular",fontWeight:'500',width:screenwidth,textAlign:'center'}}>Pre-bookings</Text>
...
>
    ...
    <FontAwesomeIcon icon="log-out" color='#1B1BD0' size={25} />
            ...
            <View style={{height:50,backgroundColor:'green',flexDirection: 'row',backgroundColor:'#ffffff',marginHorizontal:130,marginTop:5}}>
          <Image transition={false} source={require('../components1/images/OrDo.png')} style={{ marginTop: 10, marginHorizontal: 20,height:50,width:100,resizeMode:"cover" }} ></Image>

           {/* <Text style={{color:'#ffffff', fontSize:36,fontFamily:'Lato-Bold',fontWeight:'bold',height:50,marginTop:15,width:100}}>OrDo</Text> */}
           </View>
            </View>
            <View style={{marginTop:10,borderRadius:10,flexDirection:'column',height:height/4-20,backgroundColor:'#ffffff',width:width-20,alignSelf:'center',alignItems:'center'
  //           , shadowColor: '#000',
  ...
  // elevation: 2
    ...
    <Carousel
          ...
          <TextTicker
          style={{ fontSize: 14, fontFamily:"Lato-Regular" ,color:'#FF3394'}}
          duration={3000}
          loop
          bounce
          repeatSpacer={50}
  ...
  shadowRadius: 2,
  elevation: 2 */}
        <View style={{marginTop:30,height:screenheight/4+2,flexDirection:'column',backgroundColor:'#ffffff',alignSelf:'center',width:width-20,alignSelf:'center',alignItems:'center'
 }}>
  ...
  shadowRadius: 2,
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
           
               <TouchableOpacity onPress={() =>{ this.props.navigation.navigate('customer', { From: 'NEW' ,TYPE:"" }) }}>
                  <Image transition={false} source={require('../components1/images/order1.png')} style={{ width: 30, height: 30 ,resizeMode:'stretch',alignSelf:'center',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                 </Image>
                 <Text style  ={{fontFamily:"Lato-Regular",fontSize:10,fontWeight:'500',width:screenwidth-10,textAlign:'center'}}>Order</Text>
                 </TouchableOpacity>
               </View>
                 {/* <TouchableOpacity onPress={() =>{ this.props.navigation.navigate('customer', { From: 'NEW' ,TYPE:"" }) }}>
  ...
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
                 ...
                 {/* <Image transition={false} source={require('../components1/images/history1.png')} style={{ width: screenwidth, height: screenwidth ,resizeMode:'stretch',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                  ...
                  <Image transition={false} source={require('../components1/images/history1.png')} style={{ width: 30, height: 30 ,resizeMode:'stretch',alignSelf:'center',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                 </Image>
                 <Text style  ={{fontFamily:"Lato-Regular",fontSize:10,fontWeight:'500',width:screenwidth-10,textAlign:'center'}}>History</Text>
  ...
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
                 ...
                 {/* <Image transition={false} source={require('../components1/images/history1.png')} style={{ width: screenwidth, height: screenwidth ,resizeMode:'stretch',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                  ...
                  <Image transition={false} source={require('../components1/images/completed1.png')} style={{ width: 30, height: 30 ,resizeMode:'stretch',alignSelf:'center',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                 </Image>
                 <Text style  ={{fontFamily:"Lato-Regular",fontSize:10,fontWeight:'500',width:screenwidth-10,textAlign:'center'}}>Completed</Text>
  ...
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
                  ...
                  <Image transition={false} source={require('../components1/images/Pending1.png')} style={{ width: 30, height: 30 ,resizeMode:'stretch',alignSelf:'center',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                 </Image>
                 <Text style  ={{fontFamily:"Lato-Regular",fontSize:10,fontWeight:'500',width:screenwidth-10,textAlign:'center'}}>Pending</Text>
  ...
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
                 ...
                 {/* <Image transition={false} source={require('../components1/images/history1.png')} style={{ width: screenwidth, height: screenwidth ,resizeMode:'stretch',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                  ...
                  <Image transition={false} source={require('../components1/images/promotions1.png')} style={{ width: 30, height: 30 ,resizeMode:'stretch',alignSelf:'center',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                 </Image>
                 <Text style  ={{fontFamily:"Lato-Regular",fontSize:10,fontWeight:'500',width:screenwidth-10,textAlign:'center'}}>Promotions</Text>
  ...
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
                 ...
                 <Text style  ={{fontFamily:"Lato-Regular",fontSize:10,fontWeight:'500',width:screenwidth-10,textAlign:'center'}}>Inventory</Text>
  ...
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
                 ...
                 {/* <Image transition={false} source={require('../components1/images/history1.png')} style={{ width: screenwidth, height: screenwidth ,resizeMode:'stretch',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                  ...
                  <Image transition={false} source={require('../components1/images/return1.png')} style={{ width: 30, height: 30 ,resizeMode:'stretch',alignSelf:'center',marginTop:-1}}  onPress={() => { this.props.navigation.navigate('customer', { From: 'HISTORY' }) }} >
                 </Image>
                 <Text style  ={{fontFamily:"Lato-Regular",fontSize:10,fontWeight:'500',width:screenwidth-10,textAlign:'center'}}>Return</Text>
  ...
  elevation: 4 ,height: screenwidth-15, width: screenwidth-15, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
                <TouchableOpacity onPress={() => { this.props.navigation.navigate('Customer',{ From: 'OG',TYPE:"OG"  }) }}>
                 ...
                 <Text style  ={{fontFamily:"Lato-Regular",fontWeight:'100',fontSize:10,width:screenwidth-10,textAlign:'center'}}>Pre-bookings</Text>
          ...
          <View style={{ backgroundColor: '#FFFFFF', marginTop: 45, height: 200, alignSelf:'center',width:screenheight}}>
