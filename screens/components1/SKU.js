    ...
    render() {
      ...
      const scrollEnabled=this.state.screenheight>height;
        ...
        return (
            ...
            {/*  */}
                <Text style={{  color: '#1B1BD0',alignSelf:'center',backgroundColor:'#FFFFFF',fontSize: 20,width:width, height: 50,fontFamily:'Lato-Regular' ,fontWeight:'bold',fontSize:22,alignSelf:'center',textAlign:"center",justifyContent:'center'}}>{Title}</Text>
          </View> 
